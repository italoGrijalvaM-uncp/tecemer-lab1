...
# mismas coordenadas usadas en la semana 2(Huancayo)
LATITUD, LONGITUD = -12.07, -75.21
DIAS_HISTORIAL = 90  # cuantos dias hacia atras se consultan
DIAS_REZAGO = 5  # el archivo histórico de Open-Meteo tiene algunos dias de rezago
